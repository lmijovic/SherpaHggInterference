...
[
  ...
  DIMLIBS="-L\${DIMBUILDDIR}/Tools -L\${DIMBUILDDIR}/Shower -L\${DIMBUILDDIR}/Gauge -L\${DIMBUILDDIR}/Lorentz -L\${DIMBUILDDIR}/Main \
		-lDIMTools -lDIMShower -lDIMGauge -lDIMLorentz -lDIMMain"
  AC_SUBST(DIMDIR)
